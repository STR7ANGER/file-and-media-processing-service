# File and Media Processing Service — Build Plan
...
Pipeline/worker architecture: Next.js asset console; Hono API; Go upload coordinator; Rust media worker; PostgreSQL/Prisma; MongoDB metadata; object storage; Redis queues.
...
Next.js, TypeScript, shadcn/ui, Zustand, Hono, Go, Rust, Prisma, PostgreSQL, MongoDB, Redis, S3-compatible storage, Docker

## Core domain

Tenant, Asset, AssetVersion, Upload, Transformation, Job, Derivative, Metadata, AccessPolicy, SignedUrl, ScanResult, Webhook.

## API strategy

REST multipart/presigned uploads and transformations; GraphQL asset catalog queries; webhooks/SSE for job state.
